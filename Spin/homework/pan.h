...
#define nstates0	47	/* Phil */
#define endstate0	46
short src_ln0 [] = {
	  0,  47,  52,  53,  55,  56,  58,  58, 
	 58,  58,  59,  60,  57,  62,  57,  62, 
	 63,  54,  68,  69,  70,  72,  72,  72, 
	 72,  73,  74,  71,  76,  71,  76,  77, 
	 68,  80,  80,  85,  86,  87,  92,  92, 
	 93,  93,  94,  42,  96,  42,  96,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "philosophers.pml", 1, 46 },
	{ "-", 47, 48 }
};
uchar reached0 [] = {
	  0,   1,   0,   0,   1,   0,   1,   0, 
...
#define Air0	(sizeof(P0) - Offsetof(P0, _1_me) - 1*sizeof(uchar))
...
#define HAS_TRACK	0
/* hidden variable: */	uchar want_to_eat[4];
